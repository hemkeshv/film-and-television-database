<?php
	...
	$result = mysql_query('SELECT * FROM TVSeries WHERE CONCAT(mID, title, year, plot, director, productionHouse) LIKE "%'.($_GET["key"]) .'%"', $db);
	 if (!$result) {
...
<body>
	...
	<ul>
  	...
  	<fieldset class="fs">
    	...
    	<div>
      	...
      	<div>
      		<div class = "head3" style = "padding: 10px">PROMO</div>
  	...
  	<div class = "head2">THE PLOT</div>
        ...
        <div class="head2">Telecast Date:</div><?php echo "<div class = \"md\">" .$row["releaseDate"] ."</div> "; ?><br />
	...
	<form method="post" action="addComment.php">
           <textarea name="comments" id="comments" cols="61" rows="5" class="html-text-box" placeholder="Your Thoughts about the Show..."></textarea>
           <br>
